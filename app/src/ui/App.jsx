...
import CombatSim from './screens/CombatSim.jsx'
...
export default function App(){
  ...
  if(mode==='crew')return <Crew data={data} onBack={home} initial={crew} onChange={setCrew}/>
  if(mode==='combat')return <CombatSim data={data} onBack={home} crew={crew} onCrewChange={setCrew}/>
