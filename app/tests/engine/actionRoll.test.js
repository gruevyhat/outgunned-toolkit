...
import {actionSuccessProbability,analyseActionRoll,rollAction} from '../../src/engine/actionRoll.js'
...
describe('action rolls',()=>{
  ...
  it('calculates exact success probabilities',()=>{expect(actionSuccessProbability(2,2)).toBeCloseTo(1/6,10);expect(actionSuccessProbability(2,3)).toBe(0);expect(actionSuccessProbability(3,2)).toBeCloseTo(4/9,10);expect(actionSuccessProbability(9,2)).toBeGreaterThan(actionSuccessProbability(5,2))})
})
